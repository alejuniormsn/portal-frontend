...
import { RegistroUsuario } from "../pages/users/registro-usuario/RegistroUsuario";
...
import { GrupoDeAcesso } from "../pages/users/registro-grupo-acesso/GrupoDeAcesso";
